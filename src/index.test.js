...
assert.equal(source.includes('pathname.endsWith("/performance")'), true);
...
assert.equal(source.indexOf('pathname.endsWith("/performance")') < source.lastIndexOf('pathname.startsWith("/api/product-opportunities/")'), true);
