...
export const ADMIN_ENDPOINTS = [
  ...
  { method: "GET", path: "/admin/token", category: "Auth/session", label: "Short token lookup", description: "Returns the stored short-lived token; this existing route has no admin session guard.", type: "api", auth: false, effects: [effect("SENSITIVE RESPONSE", "danger")] },
  { method: "GET", path: "/admin/exchange-token", category: "Auth/session", label: "Long token exchange", description: "Exchanges and stores a long-lived token; this existing route has no admin session guard.", type: "api", auth: false, effects: [effect("KV WRITE"), effect("EXTERNAL API")] },
  { method: "GET", path: "/admin/me", category: "Auth/session", label: "Current Threads profile", description: "Fetches and stores the connected Threads profile; this existing route has no admin session guard.", type: "api", auth: false, effects: [effect("KV WRITE"), effect("EXTERNAL API")] },
