...
export async function discoverCurrentTopics(env, { at = new Date(), requestJson = requestOpenAiJson } = {}) {
  ...
  const result = await requestJson(env, {
    instructions: [
      ...
      "When multiple valid personaRelevance or allowedAngles are possible, prefer an interesting, useful, curious, or lightly enjoyable everyday framing over cynical or complaint-first framing. Do not force positivity over a genuinely serious topic.",
