...
export function buildCommerceContentInput({ opportunity, media, currentTopic = null }) {
  ...
  return JSON.stringify({
    ...
    instructions: {
      language: "Korean",
      format: "Write a concise, conversational Threads-native story for a realistic late-30s office worker: observant, curious, practical, warm, conversational, and lightly humorous or self-aware only when natural. The voice is never preachy, expert-like, review-article-like, artificially youthful, cynical, or generically positive. Age is context, never a writing style. Prefer short natural paragraphs, varied sentence length, and a memorable observation over exhaustive coverage. Do not force line-per-sentence formatting, emoji, fake viral formatting, or a closing rhetorical question.",
      story: "ProductOpportunity is the mandatory primary subject of the post. The story must materially remain about its problem, category/use case, situation, or directly relevant product decision. ONE POST = ONE IDEA: choose one primary interesting human observation, tension, comparison, realization, practical insight, or question, then build the post around it. Most supplied information may be omitted; omission is preferred over summary-like completeness. Do not summarize every opportunity field, product fact, feature, criterion, or Current Topic fact. Prefer one representative detail over an enumeration unless multiple details are genuinely necessary to the one selected idea. Let the idea earn attention before a natural product/problem connection; the product name need not appear in the opening or at all when the connection remains material. A natural movement may be hook or observation, concrete situation or tension, human reaction or interpretation, then a small realization or practical thought. It is not a rigid template, and no CTA, recommendation, or complete explanation is required. The post must stand on its own even without a purchase. Do not lead with catalog benefits, recommendation, CTA, SEO, listicle, feature dump, fake quote, fake dialogue, fake number, or hard-sell language. Avoid compressed buying guides, report-like hedging, generic explanatory conclusions, and A/B/C-style criteria lists. Avoid routine openings about fatigue, aging, office complaints, parenting exhaustion, or financial anxiety unless the supplied material genuinely requires them. Current Topic is optional supporting flavor only: never use it as the main story, replace the ProductOpportunity subject with it, or make the ProductOpportunity incidental merely because the topic is timely.",
      ...
      avoid: ["hard-sell language", "affiliate language", "fake urgency", "fabricated discounts or prices", "unsupported specifications", "fake testimonials", "fabricated comparison claims", "generic engagement bait", "fake personal history", "compressed buying guide", "feature or criteria enumeration", "report-like hedging", "generic explanatory conclusion"],
    },
  });
}
