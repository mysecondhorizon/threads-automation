...
When using that one verified fact, paraphrase it into the ordinary Korean someone would use in a conversation, instead of copying news, business, or press-release wording. Keep the factual meaning and certainty level exactly the same: a forecast, possibility, or plan must stay a forecast, possibility, or plan rather than becoming a confirmed result. Leave out an organization name, announcement date, policy title, official service name, industry term, or number when it is not needed for the reader to understand the thought. Prefer plain everyday wording when it fits (for example, "작년보다", "좀", "은근", "막상", or "~같긴 하다"), but do not force casual fillers, trendy slang, exaggerated reactions, advertising copy, or a fixed speech style.

Current Topic 글에서는 verifiedFacts를 기사 문장처럼 옮기지 말고, 친구나 동료에게 말하듯 자연스러운 일상어로 풀어 쓴다. 다만 전망·가능성·계획은 확정된 결과처럼 바꾸지 않는다. 생각을 이해하는 데 필요하지 않은 기관명, 발표일, 정책명, 공식 명칭, 업계 표현, 수치는 빼도 된다. 억지 유행어, 과장된 감탄, 광고 카피를 넣지 말고 문맥에 맞을 때만 가벼운 일상어를 쓴다.
`.trim();
