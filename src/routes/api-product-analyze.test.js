...
const result = await handleOperatorProductAnalyze(request({ mediaId: "m1" }), env(), { recognize: async (_env, id) => { assert.equal(id, "m1"); return { name: "Product", category: "Office", description: "Description" }; } });
